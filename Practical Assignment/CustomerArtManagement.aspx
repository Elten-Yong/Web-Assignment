        ...
        <ItemTemplate>
            <table class="auto-style1">
                <tr>
                    ...
                    <td>                                           
                        <asp:Label ID="Label7" runat="server" Text="Label">Quantity</asp:Label>          
                    </td>
                </tr>
            </table>
        </ItemTemplate>
    </asp:DataList>
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT Customer.Username, Customer.Address, Customer.PhoneNumber, Customer.Email, [Order].OrderID, [Order].CustomerID, [Order].DrawID, [Order].Date FROM [Order] INNER JOIN Customer ON [Order].CustomerID = Customer.CustomerID WHERE ([Order].DrawID = @DrawID)">
        <SelectParameters>
            <asp:Parameter Name="DrawID" />
        </SelectParameters>
    </asp:SqlDataSource>
